...
\begin{proc}{redistribucionDeLosFrutos}{\In recursos: \TLista{\float}, \In cooperan: \TLista{\bool}}{\TLista{\float}}
    ...
    \asegura{\paraTodo[unalinea]{i}{\ent}{0\geq i>|res| \implicaLuego if\ cooperan[i]\ then\ res[i] = totalARepartir(recursos, cooperan)\ else\ res[i] = recursos[i] + totalARepartir(recursos, cooperan)\ fi}}
\end{proc}
...
\pred{todosPositivos}{s: \TLista{\float}}{\paraTodo[unalinea]{i}{\ent}{0\geq i>|s| \implicaLuego s[i] > 0}}
